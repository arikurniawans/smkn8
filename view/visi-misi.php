...
<head>
	<meta charset="UTF-8">
	<title>VISI MISI - SMK NEGERI 8 BANDAR LAMPUNG</title>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h2 class="title-detail-info"><span>Visi </span>Misi</h2>
					<ol class="breadcrumb text-center">
						<li><a href="home" class="list">Beranda</a></li>
						<li><a href="visi-misi" class="list">visi misi</a></li>
					</ol>
				</div>
			</div>
		</div>
