...
<head>
	<meta charset="UTF-8">
	<title>DETAIL KEGIATAN - SMK NEGERI 8 BANDAR LAMPUNG</title>
...
<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h2 class="title-detail-info"><span>Detail </span>Kegiatan</h2>
					<ol class="breadcrumb text-center">
						<li><a href="home" class="list">Beranda</a></li>
						<li><a href="detail-kegiatan" class="list">Detail Kegiatan</a></li>
					</ol>
				</div>
			</div>
		</div>
	...
	<!--  -->
	<?php  
		if (!function_exists('tampil_detail_agenda')) {
			include 'sys/function.php';
		}
		tampil_detail_agenda();
	?>
