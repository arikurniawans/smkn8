...
<body>
	...
	<div class="page-backup">
		<div class="col-md-4 col-sm-4">  
			<!-- <p><a href="tambah-tujuan" class="add-news">Tambah Tujuan</a></p> -->
			<p class="perintah">
	...
	<div class="col-md-12 col-sm-12 page-backup-1">
		<p class="all-info"><i class="fas fa-home"></i>&nbsp;Tujuan Sekolah :</p>
		<?php  
		...
		$_SESSION['judul_tujuan'] = $data['judul'];
		$_SESSION['isi_tujuan'] = $data['isi'];
	?>
			<div class="col-md-12 berita" style="border-radius: 6px;">
				<div class="atass" style="padding: 18px 5px;">
					...
					<a href="edit-tujuan" class="btn-edit">Edit</a>
