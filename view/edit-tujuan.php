...
<body>
	...
	<form action="sys/sys_edit_tujuan.php?id=1" method="POST" enctype="multipart/form-data">
	<div class="col-md-9" style="margin-bottom: 16px;">
		<div class="page-backup-1">
			<p class="all-info"><i class="fas fa-edit"></i>&nbsp;Edit Tujuan  :</p>
			<input type="text" class="form-control title-here" name="judul" placeholder="Judul"
			value="<?= $_SESSION['judul_tujuan'] ?>">
		</div>
	</div>
	<div class="col-md-3"></div>
	<div class="col-md-9">
		<textarea class="ckeditor" id="isi" name="isi"><?= $_SESSION['isi_tujuan'] ?></textarea>
