...
<body>
	...
	<div class="page-backup">
		<div class="col-md-4 col-sm-4">  
			<!-- <p><a href="tambah-vs-su" class="add-news">Tambah Visi Misi</a></p> -->
			<p class="perintah">
	...
	<div class="col-md-12 col-sm-12 page-backup-1">
		<p class="all-info"><i class="fas fa-home"></i>&nbsp;Visi Misi Sekolah :</p>
		<!-- <table class="table table-bordered">
			...
			<tbody>
				<tr align="center">
					...
					<td>Visi Misi SMKN 8 Bandar Lampung</td>
					<td>10.00 , 10 maret 2018</td>
					<td>
						<a href="edit-vs-su" class="btn-edit">Edit</a>
	...
	<?php  
		...
		$q ="SELECT * FROM visi_misi";
		$rd = $conn->query($q);

		$data = $rd->fetch_assoc();

		$_SESSION['judul_visi'] = $data['judul'];
		$_SESSION['isi_visi'] = $data['isi'];
	?>
