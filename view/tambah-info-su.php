...
<body>
	...
	<form action="sys/sys_tambah_berita_su.php" method="POST" enctype="multipart/form-data">
	<div class="col-md-9" style="margin-bottom: 16px;">
		<div class="page-backup-1">
			<p class="all-info"><i class="fa fa-plus"></i>&nbsp;Tambah Berita Baru :</p>
			<input type="text" class="form-control title-here" name="judul" placeholder="Judul Berita">
		</div>
	</div>
	...
	<div class="col-md-3 side-add">
		...
		<button name="upload" class="publish" onclick="javascript: return confirm('yakin?')">Publish</button>
	</div>
	</form>
</body>
</html>