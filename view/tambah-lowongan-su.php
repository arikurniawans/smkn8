...
<body>
	...
	<div class="col-md-11" style="margin-bottom: 16px;">
		<form action="sys/sys_tambah_lowongan.php" method="POST" enctype="multipart/form-data">
		<div class="page-backup-1">
			<p class="all-info"><i class="fas fa-briefcase"></i>&nbsp;Profesi yang dibutuhkan :</p>
			<input type="text" class="form-control title-here" name="profesi" placeholder="Profesi">
			<!--  -->
			<div class="col-md-4 page-backup-2">
				<p class="all-info-1"><i class="fas fa-home"></i>&nbsp;Nama Industri :</p>
				<input type="text" class="form-control title-here" name="industri" placeholder="Nama Industri">
			</div>
			<!--  -->
			<div class="col-md-4 page-backup-2">
			...
			<div class="col-md-4 page-backup-2">
				...
				<input type="text" class="form-control title-here" name="lokasi" placeholder="Lokasi Industri">
			</div>
			<!--  -->
			<div class="col-md-4 page-backup-2">
				<p class="all-info-1"><i class="fas fa-map-signs"></i>&nbsp;Sumber Lowongan :</p>
				<input type="text" class="form-control title-here" name="link" placeholder="ex: www.google.com">
			</div>
			<!--  -->
			<div class="col-md-4 page-backup-2">
	...
	<div class="col-md-11 mb">
		...
		<div class="col-md-6 pa-3">
			...
			<input type="number" class="form-control title-here" name="nomor" placeholder="0895-xxxx-xxx" min="0">
		</div>
		<div class="col-md-6 pa-3">
			<p class="all-info-1"><i class="far fa-envelope"></i>&nbsp;Email Perusahaan :</p>
			<input type="email" class="form-control title-here" name="email" placeholder="example@gmail.com">
		</div>
		<!--  -->
	</div>
	<div class="col-md-11">
		...
		<button class="publish mb" name="upload">Publish</button>
	</div>
	</form>
</body>
</html>