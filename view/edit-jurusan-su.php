...
<body>
	...
	<form action="sys/sys_edit_jurusan.php?id=<?= $_GET['id'] ?>" method="POST" enctype="multipart/form-data">
	<div class="col-md-9" style="margin-bottom: 16px;">
		<div class="page-backup-1">
			<p class="all-info"><i class="far fa-edit"></i>&nbsp;Edit Jurusan :</p>
	...
	<div class="col-md-3">
		<div class="side-add">
			<p class="adds-media">
				<i class="fas fa-camera"></i>&nbsp; <span>Edit Logo Jurusan</span>
			</p>
