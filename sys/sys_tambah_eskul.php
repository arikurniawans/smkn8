	...
	if (isset($_POST['upload'])) {
		if (empty($_POST['judul']) OR empty($_POST['isi'])) {
			...
			if ($content->error == 4) {
				...
				header('location:../tambah-eskul?pesan=Tambahkan_Foto_eskul');
				...
				if (move_uploaded_file($content->tmp_foto, $dir)) {
					...
					$q_tambah = "INSERT INTO eskul VALUES('$content->id_eskul','$content->nama_foto','$content->judul','$content->isi','$content->prestasi')";
